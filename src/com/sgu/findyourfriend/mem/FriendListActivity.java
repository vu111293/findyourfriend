...
import com.sgu.findyourfriend.gps.LocationActivity;
import com.sgu.findyourfriend.phonecall.PhoneCallActivity;
import com.sgu.findyourfriend.sms.MessageActivity;
...
public class FriendListActivity extends Activity implements OnItemClickListener {
	...
	DialogInterface.OnClickListener dialogClickListener = new OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			switch (which) {
			case 0:
				/* i = new Intent(getApplicationContext(), PhoneCallActivity.class);
				Log.i("Phone number: ", friendsList.get(0).getPhoneNumber());
				i.putExtra("phoneNumber", friendsList.get(0).getPhoneNumber());
				startActivity(i);
				*/
				
				i = new Intent(Intent.ACTION_CALL);
				i.setData(Uri.parse("tel:" + friendsList.get(0).getPhoneNumber()));
				startActivity(i);
				break;
