...
public class CustomAdapter_Categories extends ArrayAdapter<Category> {
	...
	public CustomAdapter_Categories(Context context, int resource,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		item.ItemName = (TextView) convertView
				.findViewById(R.id.TextView_Categories_item_ItemName);
		item.title = (TextView) convertView
				.findViewById(R.id.TextView_Categories_Title);
		item.number = (TextView) convertView
				.findViewById(R.id.TextView_Categories_item_Number);
		item.icon = (ImageView) convertView
				.findViewById(R.id.ImageView_Categories_item_icon);
		item.headerLayout = (LinearLayout) convertView
				.findViewById(R.id.HeaderLayout);
		item.itemLayout = (LinearLayout) convertView
		...
		if (cate.getName() != null) {
			...
			if (cate.getNews() != 0) {
				...
				// Toast.makeText(ctx, String.valueOf(cate.getNews()),
