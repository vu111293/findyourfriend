...
public class FriendListAdapter extends BaseAdapter {
	...
	private List<FriendBak> mData;

	public FriendListAdapter(Context context, List<FriendBak> friendList) {
	...
	public FriendListAdapter(Context context) {
		this.context = context;
		this.mData = new ArrayList<FriendBak>();
	}

	public void addItem(FriendBak fr) {
		this.mData.add(fr);
	}
	...
	@Override
	public FriendBak getItem(int pos) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			FriendBak frd = mData.get(position);
