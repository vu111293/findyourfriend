...
public class MapFragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		avatarListView = (HorizontalListView) view.findViewById(R.id.avatarListView);
		...
		// setup view control
		txtLatitute = (TextView) view.findViewById(R.id.txtLatitute);
		txtLongtitute = (TextView) view.findViewById(R.id.txtLongtitute);
