...
public class SettingFragment extends PreferenceFragment implements
	...
	private void setupPrefs() {
		...
		switchRunBkg.setChecked(SettingManager.getInstance().isAutoLogin());
	...
	private void changePasswordDialog() {
		...
		mCurrentPassword = (EditText) mdialog.findViewById(R.id.pass_current);
		mNewPassword = (EditText) mdialog.findViewById(R.id.pass_newpass);
		mShowPassword = (CheckBox) mdialog.findViewById(R.id.chbx_showpass);
			...
			public void onClick(View v) {
				...
				if (oldPassword.equals("")) {
					...
					Utility.showDialog(Utility.ERROR, dialog,
							"Thiếu thông tin", "Nhập mật khẩu hiện tại",
				...
				if (oldPassword.equals(newPassword)) {
					...
					Utility.showDialog(Utility.ERROR, dialog,
							"Mật khẩu không đổi",
							"Nhập mật phải khác mật khẩu hiện tại", "Đóng",
							new OnClickListener() {
